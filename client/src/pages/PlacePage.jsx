...
export default function PlacePage() {
    ...
    return (
        <div className="absolute inset-0 bg-black text-white min-h-screen">
            <div className="bg-black p-8 grid gap-4">
                <div>   
                    <h2 className="text-3xl mr-48 mb-1">Photos of {place.title}</h2> 
   ...
   return (
    <div className="mt-4 bg-gray-100 -mx-8 px-8 pt-8">
        ...
        <a className="flex gap-1 my-3 block font-semibold underline" target="_blnak" href={'https://maps.google.com/?q='+place.address}>
